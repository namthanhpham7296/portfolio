...
!function (e) {
    ...
    t = {
        ...
        constructor: i, _cleanup: function () {
            ...
            var i, a, r, n, o, l, s, d, c, u, p, f, g, m, v, h, w, b, _, C, x, y, T, I, F, P, k, E, S, A, z, D, M, U, $,
                j, R, O, B, L, Z, N = this;
            ...
            var n, o, l, s, d, c, u, p, f, g, m, v, h, w = this, b = w.fileManager, _ = b.count(), C = new FormData,
                ...
                T = w.ajaxOperations.uploadThumb, I = b.getFile(a), F = {id: x, index: i, fileId: a},
                P = w.fileManager.getFileName(a, !0);
            w.enableResumableUpload || (w.showPreview && (o = w.fileManager.getThumb(a), u = o.find(".file-thumb-progress"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), u.show()), 0 === _ || !y || w.showPreview && s && s.hasClass("disabled") || w._abort(F) || (h = function () {
                ...
                f = w._parseError(T, t, n, w.fileManager.getFileName(a)), c = !0, setTimeout(function () {
                    var i;
                    r && h(), w.fileManager.setProgress(a, 100), w._setPreviewError(o, !0), w.retryErrorUploads || s.hide(), e.extend(!0, F, w._getOutData(C, t)), w._setProgress(101, i, w.msgAjaxProgressError.replace("{operation}", T)), i = w.showPreview && o ? o.find(".file-thumb-progress") : "", w._setProgress(101, i, w.msgUploadError), w._showFileError(f, F)
                }, w.processDelay)
            ...
            var v, h, w, b = this, _ = b.slug(r), C = "", x = "",
                ...
                I = _, F = "type-default", P = u || b._renderFileFooter(i, _, d, "auto", s), k = b.preferIconicPreview,
            ...
            var o, l, s, d, c, u, p, f, g, m, v = this, h = e(a.img)[0], w = h.naturalWidth, b = h.naturalHeight, _ = 1,
                ...
                I = v.imageCanvasContext, F = a.typ, P = a.pid, k = a.ind, E = a.thumb, S = a.exifObj;
            if (c = function (e, t, i) {
            ...
            F = F || v.resizeDefaultImageType, l = w > C, s = b > x, _ = "width" === v.resizePreference ? l ? C / w : s ? x / b : 1 : s ? x / b : l ? C / w : 1, v._resetCanvas(), w *= _, b *= _, T.width = w, T.height = b;
            try {
            ...
            var t = this;
            return e = e || 0, t.required && !t.getFilesCount() ? (t.$errorContainer.html(""), t._showFileError(t.msgFileRequired), !1) : t.minFileCount > 0 && t._getFileCount(e) < t.minFileCount ? (t._noFilesError({}),
                !1) : !0
            ...
            r.fileManager.clearImages(), e.each(i, function (e, t) {
                ...
                r.lock(!0);
                var _, C, x, y, T, I, F, P, k, E, S, A, z, D = i[b], M = u + "-" + r._getFileId(D), U = f.text,
