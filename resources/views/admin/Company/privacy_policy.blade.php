...
@section("content")
        ...
        <div class="col-md-12">
            <div class="card card-custom" id="kt_card_2">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            <form id="form-privacy-policy" method="post" enctype="multipart/form-data">

                                <div class="form-group">
                                    <label>{{ __("Content") }}</label>
                                    <textarea type="text" class="form-control" name="privacy_policy" id="privacy-policy"><?php echo $privacy_policy;?></textarea>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            activeSummerNote(550, 'monokai','#privacy-policy');
        });
    </script>
