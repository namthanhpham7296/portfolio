...
@section("content")
        ...
        <div class="col-md-12">
            <div class="card card-custom" id="kt_card_2">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            <form id="form-return-policy" method="post" enctype="multipart/form-data">
                                <input class="hide" name="_token" value="{{ csrf_token() }}">
                                <div class="form-group">
                                    <label>{{ __("Content") }}</label>
                                    <textarea type="text" class="form-control" name="return_policy" id="return-policy"><?php echo $return_policy;?></textarea>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            activeSummerNote(550, 'monokai','#return-policy');
        });
    </script>
