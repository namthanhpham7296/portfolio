                        ...
                        <div class="tab-pane fade show active" id="new-york" role="tabpanel" aria-labelledby="new-york-tab">
                            <div class="row">
                                <div class="col-lg-4 responsive-column">
                                    <div class="deal-card">
                                        <div class="deal-title d-flex align-items-center">
                                            <img src="{{  asset('public/assets/templates/trizen/') }}/images/airline-img.png" alt="air-line-img">
                                ...
                                <div class="col-lg-4 responsive-column">
                                    <div class="deal-card">
                                        <div class="deal-title d-flex align-items-center">
                                            <img src="{{  asset('public/assets/templates/trizen/') }}/images/airline-img2.png" alt="air-line-img">
                                            <h3 class="deal__title">
                                                <a href="flight-single.html" class="d-flex align-items-center">
                                ...
                                <div class="col-lg-4 responsive-column">
                                    <div class="deal-card">
                                        <div class="deal-title d-flex align-items-center">
                                            <img src="{{  asset('public/assets/templates/trizen/') }}/images/airline-img3.png" alt="air-line-img">
                                            <h3 class="deal__title">
                                                <a href="flight-single.html" class="d-flex align-items-center">
                                ...
                                <div class="col-lg-4 responsive-column">
                                    <div class="deal-card">
                                        <div class="deal-title d-flex align-items-center">
                                            <img src="{{  asset('public/assets/templates/trizen/') }}/images/airline-img4.png" alt="air-line-img">
                                            <h3 class="deal__title">
                                                <a href="flight-single.html" class="d-flex align-items-center">
                                ...
                                <div class="col-lg-4 responsive-column">
                                    <div class="deal-card">
                                        <div class="deal-title d-flex align-items-center">
                                            <img src="{{  asset('public/assets/templates/trizen/') }}/images/airline-img5.png" alt="air-line-img">
                                            <h3 class="deal__title">
                                                <a href="flight-single.html" class="d-flex align-items-center">
                                ...
                                <div class="col-lg-4 responsive-column">
                                    <div class="deal-card">
                                        <div class="deal-title d-flex align-items-center">
                                            <img src="{{  asset('public/assets/templates/trizen/') }}/images/airline-img6.png" alt="air-line-img">
                                            <h3 class="deal__title">
                                                <a href="flight-single.html" class="d-flex align-items-center">
                ...
                <div class="hotel-card-wrap">
                    <div class="hotel-card-carousel carousel-action">
                        <div class="card-item mb-0">
                            <div class="card-img">
                                <a href="hotel-single.html" class="d-block">
                                    <img src="{{  asset('public/assets/templates/trizen/') }}/images/img1.jpg" alt="hotel-img">
                                </a>
                        ...
                        <div class="card-item mb-0">
                            <div class="card-img">
                                <a href="hotel-single.html" class="d-block">
                                    <img src="{{  asset('public/assets/templates/trizen/') }}/images/img2.jpg" alt="hotel-img">
                                </a>
                                <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Bookmark">
                                    <i class="la la-heart-o"></i>
                                </div>
                        ...
                        <div class="card-item mb-0">
                            <div class="card-img">
                                <a href="hotel-single.html" class="d-block">
                                    <img src="{{  asset('public/assets/templates/trizen/') }}/images/img3.jpg" alt="hotel-img">
                                </a>
                        ...
                        <div class="card-item mb-0">
                            <div class="card-img">
                                <a href="hotel-single.html" class="d-block">
                                    <img src="{{  asset('public/assets/templates/trizen/') }}/images/img4.jpg" alt="hotel-img">
                                </a>
                        ...
                        <div class="card-item mb-0">
                            <div class="card-img">
                                <a href="hotel-single.html" class="d-block">
                                    <img src="{{  asset('public/assets/templates/trizen/') }}/images/img5.jpg" alt="hotel-img">
                                </a>
                                <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Bookmark">
                                    <i class="la la-heart-o"></i>
                                </div>
                        ...
                        <div class="card-item mb-0">
                            <div class="card-img">
                                <a href="hotel-single.html" class="d-block">
                                    <img src="{{  asset('public/assets/templates/trizen/') }}/images/img6.jpg" alt="hotel-img">
                                </a>
                                <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Bookmark">
                                    <i class="la la-heart-o"></i>
                                </div>
        ...
        <div class="row padding-top-50px">
            <div class="col-lg-4">
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/destination-img2.jpg" alt="destination-img">
                ...
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/destination-img3.jpg" alt="destination-img">
            ...
            <div class="col-lg-4">
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/destination-img4.jpg" alt="destination-img">
                ...
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/destination-img5.jpg" alt="destination-img">
            ...
            <div class="col-lg-4">
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/destination-img.jpg" alt="destination-img">
                ...
                <div class="car-wrap">
                    <div class="car-carousel carousel-action">
                        <div class="card-item car-card mb-0">
                            <div class="card-img">
                                <a href="car-single.html" class="d-block">
                                    <img src="{{  asset('public/assets/templates/trizen/') }}/images/car-img.png" alt="car-img">
                                </a>
                                <span class="badge">Bestseller</span>
                        ...
                        <div class="card-item car-card mb-0">
                            <div class="card-img">
                                <a href="car-single.html" class="d-block">
                                    <img src="{{  asset('public/assets/templates/trizen/') }}/images/car-img2.png" alt="car-img">
                                </a>
                                <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Save for later">
                                    <i class="la la-heart-o"></i>
                                </div>
                        ...
                        <div class="card-item car-card mb-0">
                            <div class="card-img">
                                <a href="car-single.html" class="d-block">
                                    <img src="{{  asset('public/assets/templates/trizen/') }}/images/car-img3.png" alt="car-img">
                                </a>
                                <span class="badge">featured</span>
                                <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Save for later">
                                    <i class="la la-heart-o"></i>
                        ...
                        <div class="card-item car-card mb-0">
                            <div class="card-img">
                                <a href="car-single.html" class="d-block">
                                    <img src="{{  asset('public/assets/templates/trizen/') }}/images/car-img4.png" alt="car-img">
                                </a>
                                <span class="badge">Bestseller</span>
                                <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Save for later">
                                    <i class="la la-heart-o"></i>
                        ...
                        <div class="card-item car-card mb-0">
                            <div class="card-img">
                                <a href="car-single.html" class="d-block">
                                    <img src="{{  asset('public/assets/templates/trizen/') }}/images/car-img5.png" alt="car-img">
                                </a>
                                <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Save for later">
                                    <i class="la la-heart-o"></i>
                                </div>
                        ...
                        <div class="card-item car-card mb-0">
                            <div class="card-img">
                                <a href="car-single.html" class="d-block">
                                    <img src="{{  asset('public/assets/templates/trizen/') }}/images/car-img6.png" alt="car-img">
                                </a>
                                <span class="badge">featured</span>
                                <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Save for later">
                                    <i class="la la-heart-o"></i>
            ...
            <div class="col-lg-8">
                <div class="testimonial-carousel carousel-action">
                    <div class="testimonial-card">
                        ...
                        <div class="author-content d-flex align-items-center">
                            <div class="author-img">
                                <img src="{{  asset('public/assets/templates/trizen/') }}/images/team8.jpg" alt="testimonial image">
                            </div>
                    ...
                    <div class="testimonial-card">
                        ...
                        <div class="author-content d-flex align-items-center">
                            <div class="author-img">
                                <img src="{{  asset('public/assets/templates/trizen/') }}/images/team9.jpg" alt="testimonial image">
                            </div>
                            <div class="author-bio">
                    ...
                    <div class="testimonial-card">
                        ...
                        <div class="author-content d-flex align-items-center">
                            <div class="author-img">
                                <img src="{{  asset('public/assets/templates/trizen/') }}/images/team10.jpg" alt="testimonial image">
                            </div>
                            <div class="author-bio">
        ...
        <div class="row padding-top-50px">
            <div class="col-lg-4 responsive-column">
                <div class="card-item blog-card">
                    <div class="card-img">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/blog-img.jpg" alt="blog-img">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <div class="author-content d-flex align-items-center">
                            <div class="author-img">
                                <img src="{{  asset('public/assets/templates/trizen/') }}/images/small-team1.jpg" alt="testimonial image">
                            </div>
                            <div class="author-bio">
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item blog-card">
                    <div class="card-img">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/blog-img2.jpg" alt="blog-img">
                        <div class="post-format icon-element">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <div class="author-content d-flex align-items-center">
                            <div class="author-img">
                                <img src="{{  asset('public/assets/templates/trizen/') }}/images/small-team2.jpg" alt="testimonial image">
                            </div>
                            <div class="author-bio">
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item blog-card">
                    <div class="card-img">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/blog-img3.jpg" alt="blog-img">
                        <div class="post-format icon-element">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <div class="author-content d-flex align-items-center">
                            <div class="author-img">
                                <img src="{{  asset('public/assets/templates/trizen/') }}/images/small-team3.jpg" alt="testimonial image">
                            </div>
                            <div class="author-bio">
        ...
        <div class="row">
                ...
                <div class="mobile-app-content">
                    ...
                    <div class="btn-box padding-top-30px">
                        <a href="#" class="d-inline-block mr-3">
                            <img src="{{  asset('public/assets/templates/trizen/') }}/images/app-store.png" alt="">
                        </a>
                        <a href="#" class="d-inline-block">
                            <img src="{{  asset('public/assets/templates/trizen/') }}/images/google-play.png" alt="">
                        </a>
                    </div><!-- end btn-box -->
                </div>
            </div><!-- end col-lg-6 -->
            <div class="col-lg-6">
                <div class="mobile-img">
                    <img src="{{  asset('public/assets/templates/trizen/') }}/images/mobile-app.png" alt="mobile-img">
                </div>
            </div><!-- end col-lg-5 -->
        </div><!-- end row -->
    </div><!-- end container -->
            ...
            <div class="col-lg-12">
                <div class="client-logo">
                    <div class="client-logo-item">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/client-logo.png" alt="brand image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/client-logo2.png" alt="brand image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/client-logo3.png" alt="brand image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/client-logo4.png" alt="brand image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/client-logo5.png" alt="brand image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="{{  asset('public/assets/templates/trizen/') }}/images/client-logo6.png" alt="brand image">
                    </div><!-- end client-logo-item -->
                </div><!-- end client-logo -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
